 ...
 */
export const setupLoggerMock = (): LoggerSpiesI => {
  return {
    log: jest.spyOn(Logger as any, "log").mockImplementation(() => {}),
    capture: jest.spyOn(Logger as any, "capture").mockImplementation(() => {}),
    breadcrumb: jest.spyOn(Logger as any, "breadcrumb").mockImplementation(() => {}),
    terminalLogger: jest.spyOn(Logger as any, "terminalLogger").mockImplementation(() => {}),
  };
};
